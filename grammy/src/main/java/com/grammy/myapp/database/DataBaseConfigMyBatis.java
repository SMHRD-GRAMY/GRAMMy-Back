package com.grammy.myapp.database;
...
@MapperScan(basePackages = "com.grammy.myapp.mapper")
public class DataBaseConfigMyBatis {
   ...
   public DataSource batisDataSource() {
      ...
      dataSourceConfig.setDriverClassName("oracle.jdbc.driver.OracleDriver");
       dataSourceConfig.setJdbcUrl("jdbc:oracle:thin:@project-db-stu.ddns.net:1524:xe");
       dataSourceConfig.setUsername("pjj186");
   ...
   public SqlSessionFactory batisSqlSessionFactory(@Qualifier("batisDataSource") DataSource batisDataSource, ApplicationContext applicationContext) throws Exception {
      ...
      sqlSession.setMapperLocations(applicationContext.getResources("classpath:/com/grammy/myapp/mapper/*.xml")); //쿼리문을 관리하는 mapper파일의 경로   
